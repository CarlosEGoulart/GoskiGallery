...
const DeleteArtController_1 = __importDefault(require("./controller/DeleteArtController"));
const DeleteArtistController_1 = __importDefault(require("./controller/DeleteArtistController"));
function routes(fastify, options) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        fastify.delete("/Artist", (request, reply) => __awaiter(this, void 0, void 0, function* () {
            return new DeleteArtistController_1.default().handle(request, reply);
        }));
        ...
        fastify.delete("/Art", (request, reply) => __awaiter(this, void 0, void 0, function* () {
            return new DeleteArtController_1.default().handle(request, reply);
        }));
    });
}
